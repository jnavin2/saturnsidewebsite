...
const buttonVariants = cva(
  "relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full font-display font-semibold transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 overflow-hidden",
  {
    variants: {
      variant: {
        primary:
          "bg-accent text-white hover:bg-accent-light shadow-[0_0_0_1px_rgba(139,92,246,0.4),0_8px_30px_-8px_rgba(139,92,246,0.6)] hover:shadow-[0_0_0_1px_rgba(167,139,250,0.6),0_8px_36px_-6px_rgba(167,139,250,0.7)]",
        secondary:
